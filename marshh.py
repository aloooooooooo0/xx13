...
# settings = input("Настройки\n")
# print(os.path.exists(settings))
save = r"C:\Users\super\PycharmProjects\Liki_bot_project\Settings"
...
# ---------------------------------
#Открываем файл настройек, загружаем в конструктор, проверка
try:
